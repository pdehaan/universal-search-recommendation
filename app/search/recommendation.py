...
class SearchRecommendation(object):
    ...
    def get_suggestion_engine(self):
        """
        Determine and return the appropraite subclass of BaseSuggestionEngine
    ...
    def get_query_engine(self):
        """
        Determine and return the appropraite subclass of BaseQueryEngine to use
        to fetch results.
        """
    ...
    def get_suggestions(self, query):
        """
        Queries the appropraite suggestion engine, returns the results.
        """
    ...
    @memorize(memcached, prefix='search')
